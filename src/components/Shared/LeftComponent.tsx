  ...
  return (
    <div>
      ...
      <div className="flex flex-col relative  justify-center h-full p-4 z-10 bg-opacity-50 bg-yellow-300 ">
            <Button className={`mb-2 mt-7 bg-transparent rounded-full transform transition-transform duration-200 ${location.pathname === "/" ? "bg-yellow-500 scale-105" : "hover:scale-95"}`} onClick={()=>navigate('/')}><img src={profile} alt="profile img" />Profile</Button>
